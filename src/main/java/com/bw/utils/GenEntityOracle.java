...
public class GenEntityOracle {
    ...
    private String packageOutPath = "main.com.bw.entity";// 指定实体生成所在包的路径
...
//    private static final String PASS = "tiger";
    private static final String URL="jdbc:mysql://localhost:3306/xsxone?user=root&password=wang&useUnicode=true&characterEncoding=UTF8";
...
//            return "Date";
    ...
    public static void main(String[] args) {  
        ...
        new GenEntityOracle("user","User","xsxone").init();  
    }  
}